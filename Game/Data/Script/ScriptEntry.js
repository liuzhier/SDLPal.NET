...
RoleSetDirFrame(0, 0, 0)
PartySetRole(1)
EventSetDirFrame(1, 12, 0, 4)
EventSetPos(1, 12, 336, 1608)
VideoUpdate(0, false)
SetDlgUpper(21-2-1, 0x00000000, false)
//罗刹鬼婆：
//李～逍～遥～李～逍～遥～
SetDlgLower(1-5-3, 0x00000000, false)
//李逍遥：
//哇～哇～
//作恶多端的罗刹鬼婆
VideoRestore()
...
[Item_00219_Use]
JumpIfPartyNotFacingEvent(17, 4, 1, Scr_0x9ADF)

[Scr_0x9ADF]
JumpIfPartyNotFacingEvent(17, 5, 1, Scr_0x9AE1)

[Scr_0x9AE1]
JumpIfPartyNotFacingEvent(17, 6, 1, Scr_0x9AE3)

[Scr_0x9AE3]
JumpIfPartyNotFacingEvent(17, 7, 1, Scr_0x9AE5)

[Scr_0x9AE5]
JumpIfPartyNotFacingEvent(17, 8, 1, Scr_0x9AE7)

[Scr_0x9AE7]
JumpIfPartyNotFacingEvent(17, 9, 1, Scr_0x9789)

[Item_00213_Use]
JumpIfPartyNotFacingEvent(2, 3, 1, Scr_0x9789)
EventSetTriggerScript(2, 3, Scr_0x17B8)

[Item_00212_Use]
VideoUpdate(0, false)
JumpIfPartyNotFacingEvent(3, 19, 1, Scr_0x9789)
EventSetTriggerScript(3, 19, Scr_0x13CA)

[Item_00224_Use]
JumpIfPartyNotFacingEvent(49, 31, 1, Scr_0x9789)
...
[Item_00226_Use]
JumpIfPartyNotFacingEvent(53, 2, 1, Scr_0x9789)
...
[Item_00211_Use]
JumpIfPartyNotFacingEvent(97, 4, 1, Scr_0x9B33)
EventSetTriggerScript(97, 4, Scr_0x4827)

[Scr_0x9B33]
JumpIfPartyNotFacingEvent(137, 2, 1, Scr_0x9789)
EventSetTriggerScript(137, 2, Scr_0x51D3)
RemoveItem(211, 1, Null)

[Item_00227_Use]
JumpIfPartyNotFacingEvent(118, 6, 1, Scr_0x9B3B)
EventSetTriggerScript(118, 6, Scr_0x5EDE)
RemoveItem(227, 1, Null)

[Scr_0x9B3B]
JumpIfPartyNotFacingEvent(118, 8, 1, Scr_0x9B3E)
...
[Item_00228_Use]
JumpIfPartyNotFacingEvent(100, 18, 1, Scr_0x9B4E)
EventSetTriggerScript(100, 18, Scr_0x5F0A)

[Scr_0x9B4E]
JumpIfPartyNotFacingEvent(100, 15, 1, Scr_0x9789)
EventSetTriggerScript(100, 15, Scr_0x5F1D)
RemoveItem(228, 1, Null)

[Item_00229_Use]
JumpIfPartyNotFacingEvent(47, 1, 1, Scr_0x9789)
...
[Item_00231_Use]
JumpIfPartyNotFacingEvent(192, 57, 1, Scr_0x9B5E)
EventSetTriggerScript(192, 57, Scr_0x76D6)
RemoveItem(231, 1, Null)

[Scr_0x9B5E]
JumpIfPartyNotFacingEvent(192, 58, 1, Scr_0x9789)
...
[Item_00200_Use]
JumpIfPartyNotFacingEvent(272, 2, 1, Scr_0x9789)
...
[Item_00203_Use]
JumpIfPartyNotFacingEvent(272, 4, 0, Scr_0x9B9D)
...
[Item_00204_Use]
JumpIfPartyNotFacingEvent(272, 6, 0, Scr_0x9789)
...
[Item_00205_Use]
JumpIfPartyNotFacingEvent(272, 8, 0, Scr_0x9789)
...
[Item_00206_Use]
JumpIfPartyNotFacingEvent(272, 5, 0, Scr_0x9789)
...
[Item_00207_Use]
JumpIfPartyNotFacingEvent(272, 7, 0, Item_00091_Use)
...
[Item_00232_Use]
JumpIfPartyNotFacingEvent(254, 6, 2, Scr_0x9789)
